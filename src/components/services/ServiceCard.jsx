...
export function ServiceCard({
  ...
  return (
    <div
      ...
      className={cn(
        'flex items-center gap-0 rounded-md border bg-card transition-colors cursor-pointer overflow-hidden',
    ...
    >
      {service.provider && (
        <div
          className={cn(
            'self-stretch w-2 flex-shrink-0',
            service.provider === 'gmail' && 'bg-red-200 dark:bg-red-900/60',
            service.provider === 'outlook' && 'bg-blue-200 dark:bg-blue-900/60',
          )}
          title={service.provider === 'gmail' ? 'Gmail' : 'Outlook'}
        />
      )}
